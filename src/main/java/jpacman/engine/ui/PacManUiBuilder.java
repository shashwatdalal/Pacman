...
public class PacManUiBuilder {
  ...
  public PacManUI build(final Game game) {
    ...
    return new PacManUI(game, this.buttons, this.keyMappings, this.scoreFormatter);
  }
  ...
  private void addStopButton(final Game game) {
    ...
    this.buttons.put(STOP_CAPTION, new Action() {
      @Override
  ...
  private void addStartButton(final Game game) {
    ...
    this.buttons.put(START_CAPTION, new Action() {
      @Override
      public void doAction() {
        game.start();
      }
   ...
   * @return The builder.
   */
  public PacManUiBuilder addKey(final Integer keyCode, final Action action) {
    assert keyCode != null;
    assert action != null;
   ...
   * @return The builder.
   */
  public PacManUiBuilder addButton(final String caption, final Action action) {
    assert caption != null;
  ...
  public PacManUiBuilder withDefaultButtons() {
    ...
    this.buttons.put(START_CAPTION, null);
    this.buttons.put(STOP_CAPTION, null);
    return this;
  }
   ...
   * @return The builder.
   */
  public PacManUiBuilder withScoreFormatter(final ScoreFormatter sf) {
