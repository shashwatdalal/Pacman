...
public class GameFactory {
   ...
   */
  public GameFactory(final PlayerFactory playerFactory) {
   ...
   */
  public Game createSinglePlayerGame(final Level level) {
    return new SinglePlayerGame(this.playerFact.createPacMan(), level);
  }
